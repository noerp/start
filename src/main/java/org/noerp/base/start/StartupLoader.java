 ...
 * <p>
 * When NoERP starts, the main thread will create the <code>StartupLoader</code> instance and
 ...
 * <code>start</code> method of each loader in the list. When NoERP shuts down, a
...
public interface StartupLoader {
     ...
     * will halt loader loading, so it should be thrown only when NoERP can't
     * operate without it.
     */
